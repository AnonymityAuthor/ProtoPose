...
set_cfg = dict(
    ...
    train=dict(
        type='MP100',
        ann_file='{}/mp100/annotations/mp100_cross_human_body_train.json'.format(data_root),
    ...
    val=dict(
        type='MP100',
        ann_file='{}/mp100/annotations/mp100_cross_human_body_val.json'.format(data_root),
        img_prefix='{}/mp100/images/'.format(data_root),
