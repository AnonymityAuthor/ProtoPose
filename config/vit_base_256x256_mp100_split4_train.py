...
eval_cfg = dict(
    ...
    modulate_kernel=11,
    use_udp=True,
    metric=dict(item='mPCK', pck_thr=[0.05, 0.1, 0.15, 0.2])
)
...
set_cfg = dict(
    ...
    train=dict(
        type='MP100',
        ann_file='{}/mp100/annotations/mp100_split4_train.json'.format(data_root),
    ...
    val=dict(
        type='MP100',
        ann_file='{}/mp100/annotations/mp100_split4_val.json'.format(data_root),
        img_prefix='{}/mp100/images/'.format(data_root),
...
solver = dict(
    ...
    total_epochs=50,
    eval_interval={36: 5, 42: 2, 50:1},   # epoch
